package com.coursera.algorithmsI.unionfind;
...
import com.coursera.algorithmsI.Helper;
import com.coursera.algorithmsI.stdlib.StdIn;
...
public class WeightedQuickUnionUF {
  ...
  public static void main(String[] args) {
    ...
    while (!StdIn.isEmpty()) {
      ...
      Helper.printArray(uf.sz);
      Helper.printArray(uf.id);
    }
